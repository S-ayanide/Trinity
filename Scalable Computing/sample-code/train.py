...
class ImageSequence(keras.utils.Sequence):
    def __init__(self, directory_name, batch_size, captcha_length, captcha_symbols, captcha_width, captcha_height, **kwargs):
    ...
    def __getitem__(self, idx):
        ...
        for i in range(self.batch_size):
            ...
            # Only process up to captcha_length characters
            for j, ch in enumerate(random_image_label[:self.captcha_length]):
                y[j][i, :] = 0
...
def main():
    ...
    # with tf.device('/device:XLA_CPU:0'):
        ...
        model.compile(loss='categorical_crossentropy',
                      ...
                      metrics={'char_1': 'accuracy', 'char_2': 'accuracy', 'char_3': 'accuracy', 'char_4': 'accuracy'})
